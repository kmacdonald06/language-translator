...
If your application is not running after restaging is complete, [examine the logs](https://console.bluemix.net/docs/services/CloudLogAnalysis/cfapps/logging_cf_apps.html#logging_bluemix_cf_apps_log_methods) for your application.