...
- Try out a working [demo](https://language-translator-demo.mybluemix.net/){: new_window}.
...
- Interact with the API through the [API Explorer](https://watson-api-explorer.mybluemix.net/apis/language-translator-v2){: new_window}.
